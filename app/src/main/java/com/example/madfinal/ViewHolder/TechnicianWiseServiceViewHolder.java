...
public class TechnicianWiseServiceViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public TechnicianWiseServiceViewHolder(View itemView)
    {
        super(itemView);
