...
public class TechnicianWiseRequestViewholder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public TechnicianWiseRequestViewholder(View itemView)
    {
        super(itemView);
